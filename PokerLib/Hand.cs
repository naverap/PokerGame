...
namespace PokerLib
{
    public class Hand
    {
        ...
        {
            if (hand.Contains(Card.ValueEnum.Ace) &&
                 hand.Contains(Card.ValueEnum.Two) &&
                 hand.Contains(Card.ValueEnum.Three) &&
                 hand.Contains(Card.ValueEnum.Four) &&
                hand.Contains(Card.ValueEnum.Five))
            {
                return true;
            }
        ...
        private bool Contains(Card.ValueEnum v)
        {
